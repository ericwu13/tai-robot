...
class FillsResult:
    ...
    # NOTE: display-only. GetFulfillReport(4) merges fills by commodity —
    # its price column is a day-cumulative average, never a fill price
    # (issue #92). Real fill prices come from OnNewData (src/live/fill_report).
